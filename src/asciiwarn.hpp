...
static_assert(0x21 <= '/' && '/' <= 0x7E, MSG);
static_assert('0' == 0x30, MSG);
static_assert('1' == 0x31, MSG);
static_assert('2' == 0x32, MSG);
static_assert('3' == 0x33, MSG);
static_assert('4' == 0x34, MSG);
static_assert('5' == 0x35, MSG);
static_assert('6' == 0x36, MSG);
static_assert('7' == 0x37, MSG);
static_assert('8' == 0x38, MSG);
static_assert('9' == 0x39, MSG);
static_assert(0x21 <= ':' && ':' <= 0x7E, MSG);
static_assert(0x21 <= ';' && ';' <= 0x7E, MSG);
static_assert(0x21 <= '<' && '<' <= 0x7E, MSG);
